...
<code>(New-Object System.Net.WebClient).DownloadFile("url-here","inst.ps1"); ./inst.ps1 <b>-py 2</b>; rm -Force ./inst.ps1;</code>

<code>(New-Object System.Net.WebClient).DownloadFile("url-here","inst.ps1"); ./inst.ps1 <b>-py 3</b>; rm -Force ./inst.ps1;</code>

You can also use the -retry flag in order to automaticall install python 2 if python 3 fails to install

<code>(New-Object System.Net.WebClient).DownloadFile("url-here","inst.ps1"); ./inst.ps1 <b>-retry</b>; rm -Force ./inst.ps1;</code>
